...
| S6 | Task detail + TestInDevPanel | merged | #583 | verify + on-device 2026-07-18 | ledger: `.planning/agent-plans/react-slice-s6.md` |
| S7 | Shell inversion + Svelte removal | review | — | verify + on-device 2026-07-18 | ledger: `.planning/agent-plans/react-slice-s7.md` |
