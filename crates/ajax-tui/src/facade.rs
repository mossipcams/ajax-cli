use crate::cockpit_state::{App, CockpitSnapshot};
#[cfg(test)]
use crate::input;
use crate::{layout, rendering};

#[cfg(test)]
mod cockpit_state {
    pub(crate) use crate::cockpit_state::*;
}
use ajax_core::{
...
use layout::selectable_row_layout;
#[cfg(test)]
use layout::{feed_screen_rows, feed_top_row};
...
impl App {
    ...
    pub(crate) fn ensure_visible(&mut self, viewport_h: usize) {
        if viewport_h == 0 {
            return;
        }
        let layout = selectable_row_layout(self);
