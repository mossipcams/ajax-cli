...
export const STYLES_SOURCE_MODULE_RELS = [
  ...
  "styles/settings.css",
  "styles/session.css",
  "styles/session/activity.css",
  "styles/session/composer.css",
  "styles/session/live-head.css",
  "styles/session/sheets.css",
  "styles/session/shell.css",
  "styles/session/transcript.css",
