...
import { emptyFindings, memoryPath, readJson, resultsDir, validateFindingsSchema, writeJson } from "./lib.mjs";
...
export function classifyFindings(doc, { openBugs = [], closedBugs = [], memory = {} } = {}) {
