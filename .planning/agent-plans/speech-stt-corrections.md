...
1. Editable TerminalComposer: speech → composer → explicit Insert → PTY.
...
- Round 5 deleted unused `speechInsertLedger` (auto-PTY undo path) once composer
  destination replaced auto-insert.
